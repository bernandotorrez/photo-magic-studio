-- Add invoice_no column to payments table
...
BEGIN
  ...
  -- Construct invoice number: INV/DD/MM/YYYY/XXXX
...
-- Create trigger function to auto-generate invoice_no on insert
...
-- Update existing records with invoice numbers
DO $$
DECLARE
