-- =====================================================
-- FIX BONUS TOKEN CALCULATION
-- =====================================================
-- Update process_approved_payment untuk menghitung bonus token dengan benar:
-- 1. Bonus dari paket subscription (dari payments.bonus_tokens yang sudah diisi frontend)
-- 2. Bonus dari kode unik (unique_code / 1000, rounded down)
...
-- Test: Check existing payments with bonus tokens
SELECT 
  id,
  user_email,
  tokens_purchased,
  ...
  created_at
FROM payments
WHERE bonus_tokens > 0 OR unique_code >= 1000
...
-- SELESAI!
-- =====================================================
-- Function sudah diupdate untuk menghitung:
-- 1. Bonus dari paket (payments.bonus_tokens dari frontend)
-- 2. Bonus dari kode unik (unique_code / 1000)
-- Total bonus = bonus_from_package + bonus_from_unique_code
